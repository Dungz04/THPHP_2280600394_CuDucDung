...
class ProductController
{
    ...
    public function add()
    {
        checkRole('admin'); // Chỉ admin mới có quyền
    ...
    public function edit($id)
    {
        ...
        $categories = (new CategoryModel($this->db))->getCategories();
        if ($product) {
            include 'C:\laragon\www\webbanhang\app\views\product\edit.php';
        } else {
            echo "Không thấy sản phẩm.";
        }
    }
    ...
    public function removeFromCart($id)
    {
        ...
        header('Location: /webbanhang/Product/cart'); // Quay lại trang giỏ hàng
        exit();
    }
